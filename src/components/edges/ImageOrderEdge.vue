<template>
  ...
  <EdgeLabelRenderer>
    ...
    >
      ...
      >
        <button 
          class="flex items-center justify-center w-7 h-7 text-xs font-bold rounded-full bg-[var(--bg-secondary)] text-[var(--text-primary)] border border-[var(--border-color)] shadow-md hover:scale-110 transition-transform"
        >
          {{ currentOrder }}
        </button>
      </n-dropdown>
